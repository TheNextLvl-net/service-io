...
public interface CurrencyHolder {
     ...
     * @throws UnsupportedOperationException if {@link #hasMultiCurrencySupport()} is {@code false}
     */
    default boolean hasCurrency(final String name) {
        throw new UnsupportedOperationException("Not implemented yet");
    }
     ...
     */
    @Contract("_, _ -> new")
    default Currency createCurrency(final String name, final Consumer<Currency.Builder> builder) throws IllegalArgumentException {
        throw new UnsupportedOperationException("Not implemented yet");
    }
     ...
     * @throws IllegalArgumentException      if a currency with the same name already exists
     */
    default Currency createCurrency(final Currency.Builder builder) {
     ...
     * @throws UnsupportedOperationException if {@link #hasMultiCurrencySupport()} is {@code false}
     */
    default boolean deleteCurrency(final String name) {
        throw new UnsupportedOperationException("Not implemented yet");
    }
