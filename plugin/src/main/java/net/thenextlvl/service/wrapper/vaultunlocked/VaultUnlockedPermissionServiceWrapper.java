package net.thenextlvl.service.wrapper.vaultunlocked;
...
@NullMarked
public final class VaultUnlockedPermissionServiceWrapper extends Permission implements Wrapper {
    private final @Nullable GroupController groupController;
    private final PermissionController permissionController;

    public VaultUnlockedPermissionServiceWrapper(
